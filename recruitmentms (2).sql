...
(1, 21, 3, 2, '2024-05-01', '22:55', 5),
(2, 22, 3, 1, '2024-05-01', '10:20', 1),
(3, 23, 3, 1, '2024-05-15', '01:34', 7),
(4, 24, 3, 3, '2024-05-01', '17:10', 3),
(5, 25, 3, 1, '2024-05-15', '04:56', 4),
(6, 26, 3, 1, '2024-05-21', '17:42', 5),
...
--
-- Stand-in structure for view `try1`
...
,`applicant_id` int(3)
,`position_id` int(3)
,`user_interviewee_id` int(3)
,`interview_date` date
,`interview_time` varchar(255)
,`application_status_id` int(3)
);
...
--
-- Structure for view `try1`
--
DROP TABLE IF EXISTS `try1`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `try1`  AS SELECT `application_status`.`status_id` AS `status_id`, `application_status`.`applicant_id` AS `applicant_id`, `application_status`.`position_id` AS `position_id`, `application_status`.`user_interviewee_id` AS `user_interviewee_id`, `application_status`.`interview_date` AS `interview_date`, `application_status`.`interview_time` AS `interview_time`, `application_status`.`application_status_id` AS `application_status_id` FROM `application_status` ;
